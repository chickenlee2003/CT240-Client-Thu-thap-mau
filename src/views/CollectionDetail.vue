...
<script scoped>
  ...
  export default {
    ...
    setup() {
      ...
      watch(
        [() => collectionUpdate.collection_start, () => collectionUpdate.collection_end, () => project.value?.project_created_at],
        ([newStart, newEnd, newCreatedAt], [oldStart, oldEnd, oldCreatedAt]) => {
          console.log(newCreatedAt);
          if (newEnd && newStart && newEnd < newStart) {
            collectionUpdate.collection_end = collectionUpdate.collection_start;
          }
          if (newStart && newStart < newCreatedAt) {

            collectionUpdate.collection_start = formatDateTimeToInput(newCreatedAt);
          }
        }
      );
