        ...
        <q-card>
          ...
          <q-list bordered>
            ...
            <q-item clickable v-ripple @click="logout">
              <q-item-section class="avatar-link-section1">
                <q-icon size="30px" name="logout" class="avatar-link-icon" />
              </q-item-section>
              <q-item-section class="avatar-link-section2">
                <span class="div2">Đăng xuất</span>
              </q-item-section>
            </q-item>
          </q-list>
        </q-card>
        ...
        <q-scroll-area class="fit side-bar-container" style="height: 80% !important">
          <q-list class="side-bar-list-container">
            <div v-for="pro in getProjects" :key="pro.project_id">
              <div @click="goToProject(pro.project_id)" v-if="
